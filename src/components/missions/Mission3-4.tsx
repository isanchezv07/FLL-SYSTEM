    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-xs text-blue-600 font-bold uppercase tracking-widest">
          Mineshaft Explorer and Careful Recovery
        </p>
      </div>
      <section className="grid grid-cols-2 grid-rows-2 sm:grid-cols-2 gap-4">
        <div className="bg-white rounded-xl overflow-hidden border border-slate-200 shadow-sm">
          <img src="/missions/mission3-4_1.webp" className="w-full h-auto" alt="Misión 3-4" />
        </div>
        <div className="bg-white rounded-xl overflow-hidden border border-slate-200 shadow-sm">
          <img src="/missions/mission3-4_2.webp" className="w-full h-auto" alt="Misión 3-4" />
        </div>
        <div className="bg-white rounded-xl overflow-hidden border border-slate-200 shadow-sm">
          <img src="/missions/mission3-4_3.webp" className="w-full h-auto" alt="Misión 3-4" />
        </div>
        <div className="bg-white rounded-xl overflow-hidden border border-slate-200 shadow-sm">
          <img src="/missions/mission3-4_4.webp" className="w-full h-auto" alt="Misión 3-4" />
        </div>
      </section>
