    ...
    <div className="space-y-6">
      ...
      <section className="grid grid-cols-2 sm:grid-cols-2 gap-4">
        <div className="bg-white rounded-xl overflow-hidden border border-slate-200 shadow-sm col-span-2">
          <img src="/missions/mission15_1.webp" alt="Misión 15" className="w-full h-auto"/>
        </div>
        <div className="bg-white rounded-xl overflow-hidden border border-slate-200 shadow-sm row-start-2">
          <img src="/missions/mission15_2.webp" alt="Misión 15" className="w-full h-auto"/>
        </div>
        <div className="bg-white rounded-xl overflow-hidden border border-slate-200 shadow-sm row-start-2">
          <img src="/missions/mission15_3.webp" alt="Misión 15" className="w-full h-auto"/>
        </div>
      </section>
