    ...
    <div className="space-y-6">
      ...
      <section className="grid grid-cols-2 grid-rows-2 sm:grid-cols-2 gap-4">
        <div className="bg-white rounded-xl overflow-hidden border border-slate-200 shadow-sm">
          <img src="/missions/mission2_1.webp" className="w-full h-auto" alt="Misión 2" />
        </div>
        <div className="bg-white rounded-xl overflow-hidden border border-slate-200 shadow-sm">
          <img src="/missions/mission2_2.webp" className="w-full h-auto" alt="Misión 2" />
        </div>
        <div className="bg-white rounded-xl overflow-hidden border border-slate-200 shadow-sm">
          <img src="/missions/mission2_3.webp" className="w-full h-auto" alt="Misión 2" />
        </div>
        <div className="bg-white rounded-xl overflow-hidden border border-slate-200 shadow-sm">
          <img src="/missions/mission2_4.webp" className="w-full h-auto" alt="Misión 2" />
        </div>
      </section>
