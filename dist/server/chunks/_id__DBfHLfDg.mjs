...
import { m as missionBounds, M as MatchTimer, a as missionValueFromMissionsFlat, b as missionValueToPatch } from './MatchTimer_CpR2t2cG.mjs';
...
const $$id = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": title || "Misión" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "MisionSelector", MisionSelector, { "id": id, "client:load": true, "client:component-hydration": "load", "client:component-path": "@/components/missions/MissionSelector", "client:component-export": "default" })} ` })}`;
