...
import { M as MatchTimer, a as missionValueFromMissionsFlat, m as missionBounds, b as missionValueToPatch } from './MatchTimer_CK6rOva0.mjs';
import { LayoutDashboard, LogOut, Users, Settings, Trophy, RefreshCw, UserPlus, User, Key, Shield, Trash2, EyeOff, Eye, Check, Copy, ChevronLeft, ChevronRight, Pause, RotateCcw, Layers, Target, X, Square, Play, Megaphone, Save } from 'lucide-react';
...
function MatchesSection() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-10 pb-20 animate-in fade-in duration-700", children: [
    /* @__PURE__ */ jsx("div", { className: "sticky top-4 z-40 bg-slate-900/80 backdrop-blur-2xl border-2 border-slate-800 rounded-[40px] p-6 shadow-[0_32px_64px_rgba(0,0,0,0.5)]", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col xl:flex-row gap-8 items-center justify-between", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex bg-slate-950 p-2 rounded-2xl border border-slate-800 mr-4", children: [
          /* @__PURE__ */ jsx(
            "button",
            {
              onClick: () => {
        ...
        !selectionMode ? /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(
          "button",
          {
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 bg-slate-950/50 p-3 rounded-[24px] border border-slate-800/50", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col px-2 border-r border-slate-800", children: [
          /* @__PURE__ */ jsx("span", { className: "text-[8px] font-black text-slate-600 uppercase tracking-widest mb-1 text-center", children: "Canchas" }),
          /* @__PURE__ */ jsx(
            "select",
            {
      ...
      /* @__PURE__ */ jsx("div", { className: "flex gap-12 overflow-x-auto pb-12 scrollbar-hide snap-x", children: rounds.map((round) => /* @__PURE__ */ jsxs("div", { className: "flex-shrink-0 w-80 space-y-8 snap-start", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "space-y-6", children: round.matches.map((match) => /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            className: `group relative bg-slate-900/40 border-2 rounded-[32px] p-6 cursor-pointer transition-all duration-500 hover:scale-[1.05] hover:bg-slate-900 shadow-2xl ${selectedIds.includes(match.id) ? "border-amber-500 bg-amber-500/10 shadow-amber-500/20" : match.status === "in_progress" ? "border-blue-500 shadow-blue-500/20 bg-slate-900 animate-pulse-slow" : "border-slate-800 hover:border-slate-700"}`,
            children: [
              selectedIds.includes(match.id) && /* @__PURE__ */ jsx("div", { className: "absolute -top-3 left-1/2 -translate-x-1/2 bg-amber-500 text-white px-3 py-1 rounded-full text-[8px] font-black uppercase tracking-widest z-30 animate-bounce", children: "Seleccionado" }),
              ...
              /* @__PURE__ */ jsx("div", { className: "absolute -top-3 right-4 z-20 flex gap-1", children: Array.from({ length: timerState.fieldCount }).map((_, idx) => {
                ...
                return /* @__PURE__ */ jsx(
                  "button",
                  {
                    ...
                    className: `w-5 h-5 rounded-full text-[8px] font-black flex items-center justify-center border transition-all ${isAssigned ? "bg-blue-600 border-blue-400 text-white shadow-[0_0_10px_rgba(37,99,235,0.5)]" : "bg-slate-900 border-slate-800 text-slate-600 hover:border-slate-500"}`,
                    children: idx + 1
                  },
                  f
                );
...
function ScoresSection() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-8 animate-in fade-in duration-700", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 gap-4", children: ranking.length > 0 ? ranking.map((team, index) => {
      ...
      /* @__PURE__ */ jsx("div", { className: "w-20 h-20 bg-slate-900 rounded-3xl flex items-center justify-center mx-auto mb-6 border border-slate-800", children: /* @__PURE__ */ jsx(Users, { className: "w-10 h-10 text-slate-700" }) }),
