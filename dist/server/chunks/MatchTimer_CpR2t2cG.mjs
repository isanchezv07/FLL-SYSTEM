...
function MatchTimer() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "group flex items-center gap-4 bg-white/70 backdrop-blur-xl px-5 py-2.5 rounded-2xl border border-white shadow-lg shadow-gray-200/50 transition-all hover:border-gray-200", children: [
    /* @__PURE__ */ jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsx(Clock, { className: `w-5 h-5 transition-colors ${timer.isRunning ? "text-[#006847]" : "text-gray-300"}` }),
      timer.isRunning && /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-[#006847]/10 blur-md rounded-full animate-pulse" })
    ] }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col border-l border-gray-100 pl-4 h-full justify-center", children: [
      /* @__PURE__ */ jsx("span", { className: "text-[8px] font-black text-gray-400 uppercase tracking-[0.2em] leading-none mb-1", children: "Status" }),
      /* @__PURE__ */ jsx("span", { className: `text-[10px] font-bold uppercase tracking-widest leading-none ${timer.isRunning ? "text-[#006847]" : "text-[#CE1126]"}`, children: timer.isRunning ? "Live" : "Stop" })
    ] })
  ] });
}
